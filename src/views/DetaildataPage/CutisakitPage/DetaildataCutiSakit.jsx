...
const DetaildataCutiSakit = (props) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cellExport: (row) => formatTimestamp(row.tglMulai) || "-",
      sortable: true,
    },
    {
      name: "Tgl. Selesai",
      selector: (row) => formatTimestamp(row.tglSelesai) || "-",
      cellExport: (row) => formatTimestamp(row.tglSelesai) || "-",
      sortable: true,
    },
    {
      name: "Tgl. Masuk",
      selector: (row) => formatTimestamp(row.tglMasuk) || "-",
      cellExport: (row) => formatTimestamp(row.tglMasuk) || "-",
      sortable: true,
    },
    {
      name: "Jml. Cuti",
      selector: (row) => row.jmlCuti || "-",
      cellExport: (row) => row.jmlCuti || "-",
      sortable: true,
    },
    {
      name: "Keperluan Cuti",
      selector: (row) => row.keperluanCuti || "-",
      cellExport: (row) => row.keperluanCuti || "-",
      sortable: true,
    },
    {
      name: "Status",
